...
function Clock() {
    ...
    const stringTime =date.toLocaleString('ru-RU', {hour:'numeric',minute: 'numeric', second:'numeric'}) || <br/>
    ...
    const stringDate = date.toLocaleString('ru-RU',{day:'numeric',month:'numeric',year:'numeric'})
